...
i18n.SETTINGS = {
  ...
  FIELDS_SYNCING_DESCRIPTION: __( 'Only the database fields change. Your existing HTML stays untouched.', 'media-file-renamer' ),
  ...
  AUTO_DESCRIPTION: __( 'Methods are tried in order until one succeeds. Set all to "None" for manual renaming only.', 'media-file-renamer' ),
  ...
  AUTOMATIC_RENAME_DESCRIPTION: __( 'Stop automatic renaming after the first rename.', 'media-file-renamer' ),
